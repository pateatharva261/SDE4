export type PartStatus = 'done' | 'in-progress' | 'planned';

export interface LessonRef  { id: string; title: string; path: string; }
export interface ModuleDef  { title: string; lessons: LessonRef[]; }
export interface PartDef {
  id: string; num: number; title: string;
  status: PartStatus; modules: ModuleDef[];
}
export interface BackboneRef  { id: string; title: string; path: string; }
export interface ReferenceRef { id: string; title: string; path: string; }
